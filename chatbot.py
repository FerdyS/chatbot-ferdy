...
def response():
    ...
    if 'film dibintangi' in input_text or 'berikan rekomendasi film yang dibintangi' in input_text:
        ...
        return jsonify('Bot> ' + jawaban + ' ' + title)
        # print('Bot> ' + jawaban + ' ' + title)
        # print(end-start)
    elif 'film dengan genre' in input_text:
        jawaban = kernel.respond(input_text)
        input_text = stemmer.stem(input_text)
        input_text = tokenfilter(input_text)
        i = 0
        ...
        # print('Bot> ' +  jawaban + ' ' + title)
        # print(end-start)
    elif 'film yang mirip dengan' in input_text:
        jawaban = kernel.respond(input_text)
        input_text = stemmer.stem(input_text)
        input_text = tokenfilter(input_text)
        i = 0
        ...
        return jsonify('Bot> Maaf saya tidak bisa menjawab pertanyaan tersebut')
